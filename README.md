...
| **Post Metadata** | Template-generated from YAML | `.post-meta`, `.post-lane`, `.post-date` | Muted secondary metadata line displaying the publication date and linked pursuit lane. |
...
| **Lane / Pursuit Cards** | `<div class="lanes-list grid-view">` | `.lanes-list`, `.lane-entry` | Multi-column grid of exploration lane summaries. |
